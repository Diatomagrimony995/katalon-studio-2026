...
## 👋 Welcome to Katalon Studio 2026
...
1. **Locate the downloaded file**  
   Go to the folder where your download was saved (usually `Downloads` or `Desktop`). You’ll see a file named something like `Katalon_Studio_2026_Setup.exe`.
...
3. **Follow the on-screen instructions**  
   The installer will walk you through a few screens. We recommend:
...
## 🧩 Understanding Your Workspace (First-Time Users)
...
3. **Record your first action**  
   Click the “Record” button in the toolbar. A browser window will open. Type `google.com` into the address bar and press Enter. Then, close the browser.
...
- **In-App Help:** Press `F1` inside Katalon Studio to open documentation.
- **Online Community:** Visit Katalon’s official forum or community groups. They’re friendly and responsive.
